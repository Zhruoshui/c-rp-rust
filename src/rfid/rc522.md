...
We will be using the RC522 RFID Card Reader Module, which is built on the MFRC522 IC (designed by NXP), operates at 13.56 MHz . This module is widely available online at an affordable price and typically comes with an RFID tag (MIFARE Classic 1K) and key fob, each containing 1 KB of memory. [See MFRC522 Datasheet](https://www.nxp.com/docs/en/data-sheet/MFRC522.pdf) for details.
...
- **Operating Voltage**: DC 3.3 V  (⚠️ Do not use 5 V or higher, it will cause damage).
